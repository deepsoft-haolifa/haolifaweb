...
<div class="p-p-base" v-if="data">
  <div class="node">
    ...
    <div class="node">
      ...
      <div class="node-title mb-10">
        <span class="b">机加工单号：</span><span class="mr-15">{{data.formNo}}</span>
      </div>
      <div class="node-title mb-10">
      ...
      <div class="node-title mb-10">
        <span class="b">待审批附件：</span><span><a class="a" target="_blank" flat style="color: #008eff" :href="orderUrl">下载机加工订单</a></span>
      </div>
    </div>
