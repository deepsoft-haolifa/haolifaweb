...
<div class="page-entryMaterial-form abs scroll-y">
  <div class="form-content">
    ...
    <div class="flex-v-center">
      <select-box v-model="form.storeRoomId" :list="roomList" class="mr-10" label="所属库房" style="width: 20%"></select-box>
      <select-box v-model="form.storeRoomRackId" :list="rackList" class="mr-10" label="所属库位" style="width: 20%"></select-box>
