...
<div class="page-supplier-info abs scroll-y">
  <div class="content">
    ...
    <table class="f-14" v-if="info.id">
      <tr>
        <td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td><td style="width: 10%;"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2">{{info.totalFactoryArea}} <span class="f-12 c-8">平米</span></td>
        <th colspan="1">建筑面积：</th>
        <td colspan="2">{{info.totalArchitArea}} <span class="f-12 c-8">平米</span></td>
        <th colspan="1">班次：</th>
      ...
      <tr>
        ...
        <td colspan="1">{{info.staffInfo.totalWorkers}} <span class="f-12 c-8">人</span></td>
        <th colspan="1">管理人员：</th>
        <td colspan="1">{{info.staffInfo.managerWorkers}} <span class="f-12 c-8">人</span></td>
        <th colspan="1">生产工人：</th>
        <td colspan="1">{{info.staffInfo.productionWorkers}} <span class="f-12 c-8">人</span></td>
        <th colspan="1">技术人员：</th>
        <td colspan="1">{{info.staffInfo.technicistWorkers}} <span class="f-12 c-8">人</span></td>
        <td colspan="2"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2">{{info.financialInfo.netWorth}} <span class="f-12 c-8">万元</span></td>
        <th colspan="1">目前负债：</th>
        <td colspan="2">{{info.financialInfo.liabilities}} <span class="f-12 c-8">万元</span></td>
        <th colspan="1">目前资产：</th>
        <td colspan="3">{{info.financialInfo.asset}} <span class="f-12 c-8">万元</span></td>
      </tr>
      <tr>
        <td colspan="10" class="b">近三年经营情况</td>
      </tr>
      <tr v-for="item in info.financialInfo.businessStateList" :key="item.id">
        <td colspan="1">{{item.year}} <span class="f-12 c-8">年</span></td>
        <th colspan="1">年销售额：</th>
        <td colspan="2">{{item.sale}} <span class="f-12 c-8">万元</span></td>
        <th colspan="1">利润：</th>
        <td colspan="2">{{item.profit}} <span class="f-12 c-8">万元</span></td>
        <th colspan="1">备注：</th>
