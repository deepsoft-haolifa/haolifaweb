<template>
    <div class="apply-buy-add">
        <div class="content">
            <div class="title b f-18">送检单详情</div>
            <div class="flex">
                <date-picker v-model="form.inspectNo" hint="必填" class="flex-item" label="质检单号" style="margin-right: 20px;"></date-picker>
                ...
                <input-box v-model="form.testNumber" class="flex-item" label="检测数量"></input-box>
                <input-box v-model="form.qualifiedNumber" class="flex-item" label="合格数量"></input-box>
                <input-box v-model="form.unqualifiedNumber" class="flex-item" label="不合格数量"></input-box>
            ...
            <div class="flex">
                ...
                <btn big flat @click="$router.back()">返回</btn>
            </div>
        </div>
    </div>
</template>
